...
class GAN_trainer:
    ...
    def get_real_sample_images_data(self, n_samples, n_patch=1, seed=None):
        ...
        rand_i = rnd.choice(self.in_imags.shape[0], n_samples, replace=True)
        
        # X_real_A is input, X_real_B is target
        X_real_A, X_real_B = self.in_imags[rand_i], self.tg_images[rand_i]
